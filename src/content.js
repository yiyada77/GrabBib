...
function neurips() {
  ...
  resArr.push(
    `booktitle = {${
      document.getElementsByName('citation_journal_title')[0].content
    }},\n`
  )
...
function ieee() {
  ...
  //     return;
  // }
  //   https://ieeexplore.ieee.org/rest/search/citation/format?recordIds=9499913&download-format=download-bibtex&lite=true
